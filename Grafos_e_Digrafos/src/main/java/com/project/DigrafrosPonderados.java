...
public class DigrafrosPonderados extends Vertice_Vizinho {

    public DigrafrosPonderados(float valor_peso, String valor_vertice) {
        ...
        do { // usado na logica do while
            ...
            switch (opcao_usuario) { // Pega oque o usuario adicionou e para cada caso de entrada, faça oque deve ser
                ...
                case "7":
                    ...
                    } while (verifica_existencia_vertice_caminho != true); // Enquanto não adicionar valores verdadeiros
                                                                           // ao dos
                    // vertices existes, fica repetindo
    ...
    public static String CaminhoMaisCurto(HashMap<String, LinkedList<Vertice_Vizinho>> graph, String source,
            String destination) {
        // Método para encontrar o caminho mais curto entre dois vértices em um grafo
    ...
    public static int VerificaGrau(HashMap<String, LinkedList<Vertice_Vizinho>> Valores_inseridos,
            String vertice_grau) {
